...
var mainController = function ($scope, $location, $http) {
    ...
    $http({
        ...
        url: 'server.php',
        params: [
            {theme: 'landing', themeview: 'national'},
            {theme: 'landing2', themeview: 'national2'}
        ]
    ...
    $scope.filterByTastiness = function (value) {
        var found, foundSushiRoll;
        found = _.findWhere($scope.tastiLevels, {code: value.tastiness, isChecked: true});
        foundSushiRoll = _.findWhere($scope.sushiRolls, {code: value.name, isChecked: true});
...
angular.module('sortApp', []).controller('mainController', mainController);
